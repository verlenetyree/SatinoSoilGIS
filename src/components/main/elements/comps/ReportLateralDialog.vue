<template>
  ...
  >
    <v-card>
      ...
      <ReportLateralBuilder :chartData="data" :callExport="this.export" />
    </v-card>
  </v-dialog>
</template>

<script>
import ReportLateralBuilder from "@/components/main/elements/comps/ReportLateralBuilder.vue";

export default {
  components: { ReportLateralBuilder },
  props: {
